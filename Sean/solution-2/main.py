...
def main():
    level_path  = _resolve_path(sys.argv[1]) if len(sys.argv) > 1 else SCRIPT_DIR / "1.txt"
    output_path = _resolve_path(sys.argv[2]) if len(sys.argv) > 2 else SCRIPT_DIR / "submission.txt"
